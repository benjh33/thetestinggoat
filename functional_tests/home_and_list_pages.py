...
class HomePage(object):
    ...
    def get_item_input(self, text=ITEM_INPUT_ID):
        return self.test.browser.find_element_by_id(text)
...
class ListPage(object):
    ...
    def get_share_box(self):
        return self.test.wait_for_element_with_css('input[name=email]')
    ...
    def add_new_item(self, item_text):
        current_pos = self.get_list_table_rows()
