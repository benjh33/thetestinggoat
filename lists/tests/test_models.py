...
class ItemModelsTest(TestCase):
    ...
    def test_CAN_create_duplicate_items_to_different_lists(self):
    ...
    def test_list_ordering(self):
        list_ = List.objects.create()
        item1 = Item.objects.create(list = list_, text = 'text1')
        item2 = Item.objects.create(list = list_, text = 'text2')
        item3 = Item.objects.create(list = list_, text = 'text3')
